defmodule Linklyv2Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Linklyv2Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Linklyv2Web.Gettext, "errors", msg, opts)
    end
  end
